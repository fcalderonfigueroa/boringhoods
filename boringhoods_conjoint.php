...
$featurearray = array("Interest" => array("There is nothing to occupy my mind here","There is a lot to do in this house"),"Notion of time" => array("I would have a lot of time on my hands here","Time goes by quickly in this place"),"Idleness" => array("This place is very monotonous","There are different activities to do here"),"Excitement" => array("This house is boring","It would be exciting to live here"),"Happiness" => array("This place is depressing","This place makes me happy"),"Area" => array("The square footage is above average for the price","The square footage is below average for the price"),"Crime rate" => array("Crime is lower than closeby neighbourhoods","Crime is higher than closeby neighbourhoods"),"AC" => array("Includes Air Conditioning unit","Does not include Air Conditioning unit"),"School district" => array("The school district is better than nearby neighbourhoods","The school district is worse than nearby neighbourhoods"));
...
$attrconstraintarray = array(array("Area","Crime rate","AC","School district"),array("Interest","Notion of time","Idleness","Excitement","Happiness"));
